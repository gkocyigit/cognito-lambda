...
class Account(DynaModel):
    ...
    class Schema:
        ...
        last_logged_in = fields.String(allow_none=True)
        last_modified = fields.String(allow_none=True)
        ...
        date_joined = fields.String(allow_none=True)
        is_superuser = fields.Bool()
        is_staff = fields.Bool() 
        is_active = fields.Bool() 
        username= fields.String(validate=validate.Length(0,200))
